...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        q_btn.setOnClickListener(View.OnClickListener {
            if(q_name.text.toString().isEmpty()) Toast.makeText(this@MainActivity,"Please Enter Name",Toast.LENGTH_LONG).show()
            else {
                var next: Intent = Intent(this, quiz_acitivity()::class.java)
